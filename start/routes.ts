...
Route.group(() => {
  ...
  Route.get('/shops/:id', 'ShopsController.find')
...
Route.post('/cart/:id/create', 'CartController.create').middleware(['auth:optional'])
Route.post('/cart/:id/confirm', 'CartController.confirm').middleware(['auth:optional'])
...
Route.group(() => {
  ...
  Route.get('/productions/:id/dispatchs/:did', 'ProductionController.findDispatch')
  Route.get('/productions/:id/dispatchs/:did/file', 'ProductionController.fileDispatch')
  Route.post('/productions/:id/dispatchs/:did/ship-notice', 'ProductionController.createShipNotice')
  ...
  Route.post('/shop/project', 'ShopsController.addProject')
  Route.delete('/shop/project', 'ShopsController.removeProject')
...
Route.group(() => {
  ...
  Route.get('/shops', 'ShopsController.all')
  Route.get('/mail-requests', 'AdminController.getMailRequests')
  Route.post('/mail-requests', 'AdminController.sendMailRequest')
  Route.delete('/mail-requests/:id', 'AdminController.deleteMailRequest')
  Route.get('/mail-requests/export', 'AdminController.exportMailRequests')
  ...
  Route.post('/projects/:id/products', 'ProductsController.saveProject')
  Route.delete('/projects/:id/products', 'ProductsController.removeProject')
  ...
  Route.post('/projects/:id/change-transporter', 'AdminController.changeTransporter')
  ...
  Route.post('/orders/:id/shipping-payment', 'PaymentsController.shippingPayment')
  ...
  Route.get('/boxes/goodies', 'BoxController.getGoodies')
  Route.post('/boxes/goodies', 'BoxController.saveGoodie')
  Route.delete('/boxes/goodies/:id', 'BoxController.deleteGoodie')
  ...
  Route.get('/category/:id/export', 'AdminController.exportCategories')
  Route.delete('/categories/:id', 'AdminController.deleteCategory')
  Route.post('/products/create-items', 'ProductsController.createItems')
  Route.get('/products', 'ProductsController.getProducts')
  Route.get('/productsMerch/:id', 'ProductsController.getProductsMerch')
  Route.get('/products/stocks', 'ProductsController.getStocks')
  ...
  Route.get('/labels', 'LabelsController.all')
  Route.get('/labels/:id', 'LabelsController.find')
  Route.post('/labels', 'LabelsController.save')
  Route.delete('/labels/:id', 'AdminController.remove')
  ...
  Route.get('/invoices/unpaid', 'InvoicesController.exportUnpaidInvoices')
  Route.get('/invoices/export', 'InvoicesController.exportInvoices')
  Route.get('/invoices/b2c', 'InvoicesController.exportB2C')
  Route.get('/invoices/costs', 'InvoicesController.exportInvoicesCosts')
  Route.get('/invoices/:id', 'InvoicesController.getInvoice')
  Route.get('/invoices/:id/payment-reminders', 'InvoicesController.getPaymentReminders')
  Route.put('/invoices/:id/payment-reminders/:prid', 'InvoicesController.putPaymentReminder')
  Route.delete('/invoices/:id/payment-reminders/:prid', 'InvoicesController.deletePaymentReminder')
  Route.put('/invoices/:id/payment-invoices/', 'InvoicesController.putPaymentInvoice')
  Route.delete('/invoices/:id', 'InvoicesController.removeInvoice')
  Route.post('/invoices/:id/duplicate', 'InvoicesController.duplicateInvoice')
  Route.post('/invoices/:id/pennylane', 'InvoicesController.exportPennylane')
  ...
  Route.post('/order-manual/invoices', 'AdminController.saveOrderManualInvoice')
  Route.post('/order-manual/invoices/costs', 'AdminController.applyOrderManualInvoiceCosts')
  Route.delete('/order-manual/invoices', 'AdminController.removeOrderManualInvoice')
  Route.get('/order-manual/invoices/download', 'AdminController.downloadOrderManualInvoice')
  Route.post('/order-manual/import-costs', 'AdminController.importOrderManualCosts')
  ...
  Route.post('/payments/:id/refund', 'PaymentsController.refund')
  ...
  Route.post('/dispatchs/columns', 'DispatchsController.import')
  Route.post('/dispatchs/barcodes', 'DispatchsController.getBarcodes')
  ...
  Route.get('/stocks/errors', 'AdminController.getStockErrors')
