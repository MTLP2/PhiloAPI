...
Route.group(() => {
  ...
  Route.get('/projects/:id/products', 'ProjectsController.getProjectProducts')
  Route.post('/projects/:id/products', 'ProjectsController.saveProjectProduct')
  Route.delete('/projects/:id/products/:pid', 'ProjectsController.removeProjectProduct')
