...
Route.group(() => {
  ...
  Route.post('/projects/:projectId/users/:userId', 'ProjectsController.saveProjectUsers')
  Route.delete('/projects/:projectId/users/:userId', 'ProjectsController.deleteProjectUsers')
